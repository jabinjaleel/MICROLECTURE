...
class ProfileDisplayState extends State<ProfileDisplayStateful> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
         body:FutureBuilder<List<StudentDetail>>(future:StudentDB.sdb.viewStudent(),builder: (context,content){
           List<StudentDetail> an=content.data;
           return ListView.builder(itemCount: an.length,
           itemBuilder: (context,index){
             return Text(an[index].name);
    });
    })
